...
import { binarySearch, equals } from 'monaco-editor-core/esm/vs/base/common/arrays';
import { MovingAverage } from 'monaco-editor-core/esm/vs/base/common/numbers';
import { hash } from 'monaco-editor-core/esm/vs/base/common/hash'
import { CancellationToken, CancellationTokenSource } from 'monaco-editor-core/esm/vs/base/common/cancellation';
import { onUnexpectedExternalError } from 'monaco-editor-core/esm/vs/base/common/errors';
import { LRUCache } from 'monaco-editor-core/esm/vs/base/common/map';
import { commonPrefixLength } from 'monaco-editor-core/esm/vs/base/common/strings';
import { IPosition } from 'monaco-editor-core/esm/vs/editor/common/core/position';
import { IRange, Range } from 'monaco-editor-core/esm/vs/editor/common/core/range';
import { ITextModel } from 'monaco-editor-core/esm/vs/editor/common/model';
import { DocumentSymbol, DocumentSymbolProvider, DocumentSymbolProviderRegistry } from 'monaco-editor-core/esm/vs/editor/common/modes';
import { MarkerSeverity } from 'monaco-editor-core/esm/vs/platform/markers/common/markers';
import { Iterable } from 'monaco-editor-core/esm/vs/base/common/iterator';
import { LanguageFeatureRegistry } from 'monaco-editor-core/esm/vs/editor/common/modes/languageFeatureRegistry';
import { URI } from 'monaco-editor-core/esm/vs/base/common/uri';
